...
func useFromOtherOn10_51() {
  ...
  o10_51.returns10_52Introduced10_52() // expected-error {{'returns10_52Introduced10_52()' is only available on OS X 10.52 or newer}}
...
func useFromOtherOn10_52() {
  ...
  n10_52.returns10_52()
  n10_52.returns10_53() // expected-error {{'returns10_53()' is only available on OS X 10.53 or newer}}
      // expected-note@-1 {{add 'if #available' version check}}
